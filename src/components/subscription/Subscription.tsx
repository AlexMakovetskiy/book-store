...
function Subscription() {
	...
	const handleSubmit = async () => {
		if (!email) return openPopup("The email address is entered incorrectly", false);
	...
	return (
		<div className="subscribe-wrapper">
			...
			<p className="subscribe-wrapper__subtitle">
			...
			<div className="action-container">
				<div className="action-container__insert-email-container edittext-container">
					<input
						type="email"
						className="action-container__insert-email-container__textline"
						placeholder="Your email"
						onChange={handleChange}
						name="nameSurname"
					/>
				</div>
				<button className="action-container__send-email custom-btn" onClick={handleSubmit}>
					subscribe
				</button>
			</div>
