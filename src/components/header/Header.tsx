	...
	return (
		<header className="header large-container">
			...
			<div className="search-field">
				<input
					className="search-field__textline"
					type="text"
					placeholder="Search"
					onChange={handleChange}
					value={searchState.searchLine}
				/>
				<button className="search-field__action" onClick={handleSearch}>
					{!searchState.searchImg && (
						<img
							src="/assets/vector/components/header/search-button/loupe.svg"
							alt="loupe"
							className="search-field__action__image"
						/>
					)}
					{searchState.searchImg && (
						<img
			...
			<div className="tools">
				<Link to="/favorites">
					<div className="tools__link favorites">
						{!favorites.length && (
							<img
								src="/assets/vector/components/header/Toolbox/favorites.svg"
								alt="favorites"
								className="tools__link__logo"
							/>
						)}
						{!!favorites.length && (
							<img
								src="/assets/vector/components/header/Toolbox/fullFavoritessLogo.svg"
								alt="favorites"
								className="tools__link__logo"
							/>
						)}
				...
				<Link to="/basket">
					<div className="tools__link basket">
						{!basket.length && (
							<img
								src="/assets/vector/components/header/Toolbox/basket.svg"
								alt="basket"
								className="tools__link__logo"
							/>
						)}
						{!!basket.length && (
							<img
								src="/assets/vector/components/header/Toolbox/fullBasketLogo.svg"
								alt="basket"
								className="tools__link__logo"
							/>
						)}
