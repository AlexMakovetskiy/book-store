	...
	return (
		<div className="pagination-container">
			...
			<div className="row-pages-container">
				...
				{
					<>
						<Link to={`/search-data/${inputData}/${currPage}`} className="current-page-text">
							{currPage}
						</Link>
					</>
				}
			...
			<Link to={`/search-data/${inputData}/${nextPageNumber}`}>
				<button className="pagination-container__go-next-page">
					<span>Next</span>
					<img
						src="/assets/vector/components/pagination/right-arrow-pagination.svg"
						alt="next page arrow"
						className="pagination-container__go-next-page__arrow"
					/>
				</button>
			</Link>
		</div>
