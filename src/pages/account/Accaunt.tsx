...
const Accaunt = () => {
	...
	const ChangeUserData = async () => {
		...
		if (userState.password !== userState.confirmPassword) return openPopup("Entered passwords are not match!", false);
		...
		<main className="accaunt">
			...
			<div className="accaunt-data">
				...
				<div className="password-data-content">
					...
					<div className="password-data-content__current-password-block">
						<div className="accaunt-data-content__password-wrapper__passwordedit-wrapper edittext-container">
							<input
								type="password"
								className="accaunt-data-content__password-wrapper__passwordedit-wrapper__textedit"
								value="password"
								disabled
							/>
						</div>
				...
				<div className="action-tools">
					<button className="action-tools__save-action custom-btn" onClick={ChangeUserData}>
						save changes
					</button>
					<button className="action-tools__cancel-action custom-btn" onClick={SignOutUser}>
						cancel
					</button>
				</div>
			</div>
